    ...
    public  SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws  Exception {
        ...
        return httpSecurity.
                ...
                .authorizeHttpRequests(http-> {
                    http.requestMatchers(HttpMethod.GET,"/Auth/long-in").permitAll();
                    http.requestMatchers(HttpMethod.POST,"/Auth/guardar").permitAll();
                    http.requestMatchers(HttpMethod.GET, "/Auth/hello").hasAuthority("READ");
