            ...
            <div class="box">
              ...
              <form @submit.prevent="updateProfile">
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.username" readonly />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="email" v-model="profile.correo" readonly />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <label class="radio">
                      <input type="radio" v-model="profile.gender" value="M" /> Masculino
                    </label>
                    <label class="radio">
                      <input type="radio" v-model="profile.gender" value="F" /> Femenino
                    </label>
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.phone" @input="validateNumber('phone')" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.cell" @input="validateNumber('cell')" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.firstName" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.lastName" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.number" @input="validateNumber('number')" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.country" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.postcode" @input="validateNumber('postcode')" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.latitude" @input="validateNumber('latitude')" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.longitude" @input="validateNumber('longitude')" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.description" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.date" placeholder="DD/MM/YYYY" @input="validateDate('date')" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.ageUser" @input="validateNumber('ageUser')" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.dateRegister" placeholder="DD/MM/YYYY" @input="validateDate('dateRegister')" />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" v-model="profile.ageRegister" @input="validateNumber('ageRegister')" />
                  </div>
                </div>
...
const getProfile = async () => {
  try {
    ...
    message.value = 'Error al obtener el perfil. Por favor, inténtalo de nuevo.';
...
const updateProfile = async () => {
  try {
    const token = localStorage.getItem('token');
    const response = await axios.put('http://localhost:8080/api/Perfil', profile.value, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
    ...
    message.value = 'Error al actualizar el perfil. Por favor, inténtalo de nuevo.';
    messageClass.value = 'error-message';
  }
};
